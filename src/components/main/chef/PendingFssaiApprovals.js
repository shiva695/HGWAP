...
const PendingFssaiApprovals = () => {
  ...
  // On load
  useEffect(() => {
    document.title = config.documentTitle + " | Pending FSSAI Approvals";
  }, []);
      ...
      >
        ...
        >
          ...
          <Breadcrumbs separator="›">
            ...
            <Typography color="inherit">Pending FSSAI Approvals</Typography>
          </Breadcrumbs>
...
export default PendingFssaiApprovals;
