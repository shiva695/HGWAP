...
const PendingGalleryApprovals = () => {
  ...
  // On load
  useEffect(() => {
    document.title = config.documentTitle + " | Pending Gallery Approvals";
  }, []);
      ...
      >
        ...
        >
          ...
          <Breadcrumbs separator="›">
            ...
            <Typography color="inherit">Pending Gallery Approvals</Typography>
          </Breadcrumbs>
...
export default PendingGalleryApprovals;
